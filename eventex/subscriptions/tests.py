...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Murilo Sandiego',email.body)
        self.assertIn('09161842699', email.body)
        self.assertIn('murilosandiego1@gmail.com', email.body)
        self.assertIn('38991712781', email.body)
